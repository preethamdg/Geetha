...
PICS = (environ.get('PICS', 'https://envs.sh/gY0.jpeg https://envs.sh/gii.jpg https://graph.org/file/1c1a3cb814cd719ae3bd3.jpg https://graph.org/file/ccf3cbc4687263ac63420.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/f3F.jpg")
...
CODE = (environ.get('CODE', 'https://envs.sh/fz8.jpg'))
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/f3F.jpg https://graph.org/file/1a2e64aee3d4d10edd930.jpg")).split()
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002089142494"))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002089142494') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002089142494') # request channel id ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://preethamdg:Sanju@cluster0.0jlm2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "preehamdg")
...
AI_LOGS = int(environ.get("AI_LOGS", "-1002470010762")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Sanju DG') # owner username without @

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002470010762')) #Log channel id ( make sure bot is admin )
...
BOT_USERNAME = environ.get("BOT_USERNAME", "SanjudgBot")
BOT_NAME = environ.get("BOT_NAME", "Sanju")
BOT_ID = environ.get("BOT_ID", "2089142494")
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+FOxMauI5h880ODA1') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Sanju Bot')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '1002470010762'))
